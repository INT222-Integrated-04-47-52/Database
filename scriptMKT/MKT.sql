...
START TRANSACTION;
USE `Mongkolthorn`;
INSERT INTO `Mongkolthorn`.`account` (`account_id`, `fname`, `lname`, `phone`, `email`, `password`, `role`) VALUES (800001, 'Khorapin', 'Uzumaki', '0826102000', 'admin@example.com', '$2a$10$w8qB40MdYkMs3dgGGf0Pu.xxVOOzWdZ5/Nrkleo3Gqc88PF/OQhOG', 'admin');
INSERT INTO `Mongkolthorn`.`account` (`account_id`, `fname`, `lname`, `phone`, `email`, `password`, `role`) VALUES (800002, 'Noochajee', 'Kang', '0821092000', 'regular@example.com', 'user12345', 'user');
INSERT INTO `Mongkolthorn`.`account` (`account_id`, `fname`, `lname`, `phone`, `email`, `password`, `role`) VALUES (800003, 'Prapaporn', 'Xiao', '0807102000', 'user@example.com', 'user6789', 'user');
