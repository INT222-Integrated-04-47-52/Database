...
START TRANSACTION;
USE `Mongkolthorn`;
INSERT INTO `Mongkolthorn`.`size` (`size_id`, `size_name`, `proportion`, `closet_id`) VALUES (700001, 'Shoulder', 30, 800002);
INSERT INTO `Mongkolthorn`.`size` (`size_id`, `size_name`, `proportion`, `closet_id`) VALUES (700002, 'Bust', 48, 800002);
INSERT INTO `Mongkolthorn`.`size` (`size_id`, `size_name`, `proportion`, `closet_id`) VALUES (700003, 'Waist', 30, 800002);
INSERT INTO `Mongkolthorn`.`size` (`size_id`, `size_name`, `proportion`, `closet_id`) VALUES (700004, 'Hips', 30, 800002);
INSERT INTO `Mongkolthorn`.`size` (`size_id`, `size_name`, `proportion`, `closet_id`) VALUES (700005, 'Shoulder', 25, 800003);
INSERT INTO `Mongkolthorn`.`size` (`size_id`, `size_name`, `proportion`, `closet_id`) VALUES (700006, 'Bust', 42, 800003);
INSERT INTO `Mongkolthorn`.`size` (`size_id`, `size_name`, `proportion`, `closet_id`) VALUES (700007, 'Waist', 28, 800003);
INSERT INTO `Mongkolthorn`.`size` (`size_id`, `size_name`, `proportion`, `closet_id`) VALUES (700008, 'Hips', 30, 800003);
