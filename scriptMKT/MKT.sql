...
START TRANSACTION;
USE `Mongkolthorn`;
INSERT INTO `Mongkolthorn`.`account` (`account_id`, `fname`, `lname`, `phone`, `email`, `password`) VALUES (800001, 'Khorapin', 'Uzumaki', '0826102000', 'admin@example.com', 'password');
...
START TRANSACTION;
USE `Mongkolthorn`;
INSERT INTO `Mongkolthorn`.`login` (`login_Id`, `log_email`, `log_password`, `log_position`, `account_id`) VALUES (900001, 'admin@example.com', 'password', 'admin', 800001);
